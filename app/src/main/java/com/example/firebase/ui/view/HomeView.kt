...
fun HomeStatus(
    ...
    var deleteConfirm by remember { mutableStateOf<Mahasiswa?>(null) }  // Menyimpan data yang dipilih untuk dihapus
        ...
        is HomeUiState.Success -> {
            ...
            deleteConfirm?.let { data ->
                DeleteConfirmationDialog(
                    onDeleteConfirm = {
                        onDeleteClick(data)  // Hapus data
                        deleteConfirm = null  // Reset
                    },
                    onDeleteCancel = {
                        deleteConfirm = null  // Reset jika cancel
                    }
                )
            }
        }
